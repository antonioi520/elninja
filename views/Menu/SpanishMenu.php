            ...
            <div class="menu menu-row menu-wrap menu-center" id="allDiv" style="margin-top: 40px;">
                ...
                <div class="entrees">
                    ...
                    <div class="menu-item2">
                        ...
                        <p class="menu-item-description" style="color:black">Servido con arroz de jazmín.<br><b>Elige:</b> Res, Pollo, Camarones y Tofu Teriyaki.<br></p>
                    </div>
                    <div class="menu-item2">
                ...
                <div class="entrees">
                    ...
                    <div class="menu-item2">
                        ...
                        <p class="menu-item-description2">Arroz frito del Ninja con plátano maduro, verduras, huevo. <br> <b>Su elección:</b> Pollo - Camarones<br></p>
                    </div>
                </div>
                <div class="entrees">
                    ...
                    <div class="menu-item2">
                        ...
                        <p class="menu-item-description2">Mezcla de lechuga, mango, queso feta, nueces, cebolla, tomates cherry, pimientos and aguacate y nuestra vinagreta balsámica asiática. <br> <b>Su elección:</b> Carne de res - Camarones - Pollo<br></p>
                    </div>
                    <div class="menu-item2">
